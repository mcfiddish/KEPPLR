...
::
    ...
    spacecraft.newhorizons.shapeModel = spacecraft/new_horizons_dds.glb
...
If you want to specify texture maps or shape models for other bodies, add them here.  For example:
