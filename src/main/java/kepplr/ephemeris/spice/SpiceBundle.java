...
public class SpiceBundle {
    ...
    public static final class Builder {
         ...
         *
         * <p>These values are combined with assignments parsed from any metakernels and with the kernel pool generated by
         * the loaded SPICE environment.
         *
        ...
        /**
         * Creates an empty builder with no kernels, no additional sources, and a fresh
