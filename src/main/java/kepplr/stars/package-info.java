/**
 * Star catalog interfaces. The star catalog package utilizes the indirect data model, so the star interface itself is
 * rather sparse.
 *
 ...
 * in the services package are designed specifically to support this type of aggregation.
 *
