 ...
 * {@link SimulationState#bodiesInViewProperty()} to the FX bridge. A body appears in this list
 * when it is not culled (apparent radius &ge; 2 px, or a non-satellite sprite).
 *
