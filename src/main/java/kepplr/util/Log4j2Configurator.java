...
public class Log4j2Configurator {
        ...
        for (String loggerName : loggerMap.keySet()) {
            ...
            for (String appenderName : appenderMap.keySet()) {
                ...
                if (oldAppender instanceof ConsoleAppender) {
                    newAppender = ConsoleAppender.newBuilder()
                            .setName(appenderName)
                            .setConfiguration(config)
                            .setLayout(layout)
                            .build();
                } else if (oldAppender instanceof FileAppender) {
                    newAppender = FileAppender.newBuilder()
                            .setName(appenderName)
                            .setConfiguration(config)
    ...
    /**
     * Sets the levels of <code>parentLogger</code> and all 'child' loggers to the given <code>level</code>. This is
     * simply a call to
     *
     * <pre>
