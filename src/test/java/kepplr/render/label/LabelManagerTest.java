...
class LabelManagerTest {
    ...
    class FilterLabelsTests {
        ...
        void singleCandidate() {
            List<LabelCandidate> candidates = List.of(new LabelCandidate(399, "Earth", 100, 100, 6371));
        ...
        void wellSeparated() {
            List<LabelCandidate> candidates = List.of(
                    new LabelCandidate(399, "Earth", 100, 100, 6371),
                    new LabelCandidate(301, "Moon", 100 + MIN_SEP + 10, 100, 1737));
            List<LabelCandidate> result = LabelManager.filterLabels(new ArrayList<>(candidates));
        ...
        void closeLabelSuppressed() {
            ...
            candidates.add(new LabelCandidate(399, "Earth", 100, 100, 6371));
            candidates.add(new LabelCandidate(301, "Moon", 105, 105, 1737));
        ...
        void exactlyAtThreshold() {
            ...
            List<LabelCandidate> candidates = new ArrayList<>();
            candidates.add(new LabelCandidate(399, "Earth", 100, 100, 6371));
            candidates.add(new LabelCandidate(301, "Moon", 100 + MIN_SEP, 100, 1737));
            List<LabelCandidate> result = LabelManager.filterLabels(candidates);
            assertEquals(2, result.size());
        }
        ...
        void threeWithMiddleSuppressed() {
            ...
            List<LabelCandidate> candidates = new ArrayList<>();
            candidates.add(new LabelCandidate(10, "Sun", 0, 0, 696000));
            candidates.add(new LabelCandidate(399, "Earth", 5, 5, 6371));
            candidates.add(new LabelCandidate(301, "Moon", 200, 200, 1737));
            List<LabelCandidate> result = LabelManager.filterLabels(candidates);
            assertEquals(2, result.size());
        ...
        void sortOrderMatters() {
            ...
            List<LabelCandidate> candidates = new ArrayList<>();
            candidates.add(new LabelCandidate(399, "Earth", 100, 100, 6371));
            candidates.add(new LabelCandidate(10, "Sun", 105, 105, 696000));
